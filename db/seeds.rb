...
trump = Machine.create(user: margot, name: "Trump election", country: "US", price: 200, period_century: 21, period_specific: 2016, details: "Election of the worst president!" )
...
louis = Machine.create(user: sophie, name: "Party with Louis XIV", country: "FR", price: 10_000, period_century: 17, period_specific: 1690, details: "Gala au Chateau de Versailles!" )
...
war = Machine.create(user: aymeric, name: "End of World War II", country: "DE", price: 100, period_century: 20, period_specific: 1945, details: "Celebrating the end of Hitler!" )
